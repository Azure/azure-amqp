...
BEGIN_TEST_SUITE(connection_unittests)
		...
		/* Tests_SRS_AMQPVALUE_01_236: [If creating the cloned value fails, amqpvalue_clone shall return NULL.] */
		/* Tests_SRS_AMQPVALUE_01_238: [boolean] */
		TEST_METHOD(when_allocating_cloned_value_fails_amqpvalue_clone_for_a_boolean_fails)
		{
			// arrange
			amqpvalue_mocks mocks;
			AMQP_VALUE source = amqpvalue_create_boolean(true);
		...
		/* Tests_SRS_AMQPVALUE_01_236: [If creating the cloned value fails, amqpvalue_clone shall return NULL.] */
		/* Tests_SRS_AMQPVALUE_01_239: [ubyte] */
		TEST_METHOD(when_allocating_cloned_value_fails_amqpvalue_clone_for_a_ubyte_fails)
		{
			// arrange
			amqpvalue_mocks mocks;
			AMQP_VALUE source = amqpvalue_create_ubyte(43);
		...
		/* Tests_SRS_AMQPVALUE_01_236: [If creating the cloned value fails, amqpvalue_clone shall return NULL.] */
		/* Tests_SRS_AMQPVALUE_01_240: [ushort] */
		TEST_METHOD(when_allocating_cloned_value_fails_amqpvalue_clone_for_a_ushort_fails)
		{
			// arrange
			amqpvalue_mocks mocks;
			AMQP_VALUE source = amqpvalue_create_ushort(43);
		...
		/* Tests_SRS_AMQPVALUE_01_236: [If creating the cloned value fails, amqpvalue_clone shall return NULL.] */
		/* Tests_SRS_AMQPVALUE_01_241: [uint] */
		TEST_METHOD(when_allocating_cloned_value_fails_amqpvalue_clone_for_a_uint_fails)
		{
			// arrange
			amqpvalue_mocks mocks;
			AMQP_VALUE source = amqpvalue_create_uint(43);
		...
		/* Tests_SRS_AMQPVALUE_01_236: [If creating the cloned value fails, amqpvalue_clone shall return NULL.] */
		/* Tests_SRS_AMQPVALUE_01_242: [ulong] */
		TEST_METHOD(when_allocating_cloned_value_fails_amqpvalue_clone_for_a_ulong_fails)
		{
			// arrange
			amqpvalue_mocks mocks;
			AMQP_VALUE source = amqpvalue_create_ulong(43);
		...
		/* Tests_SRS_AMQPVALUE_01_236: [If creating the cloned value fails, amqpvalue_clone shall return NULL.] */
		/* Tests_SRS_AMQPVALUE_01_243: [byte] */
		TEST_METHOD(when_allocating_cloned_value_fails_amqpvalue_clone_for_a_byte_fails)
		{
			// arrange
			amqpvalue_mocks mocks;
			AMQP_VALUE source = amqpvalue_create_byte(43);
		...
		/* Tests_SRS_AMQPVALUE_01_236: [If creating the cloned value fails, amqpvalue_clone shall return NULL.] */
		/* Tests_SRS_AMQPVALUE_01_244: [short] */
		TEST_METHOD(when_allocating_cloned_value_fails_amqpvalue_clone_for_a_short_fails)
		{
			// arrange
			amqpvalue_mocks mocks;
			AMQP_VALUE source = amqpvalue_create_short(43);
		...
		/* Tests_SRS_AMQPVALUE_01_236: [If creating the cloned value fails, amqpvalue_clone shall return NULL.] */
		/* Tests_SRS_AMQPVALUE_01_245: [int] */
		TEST_METHOD(when_allocating_cloned_value_fails_amqpvalue_clone_for_a_int_fails)
		{
			// arrange
			amqpvalue_mocks mocks;
			AMQP_VALUE source = amqpvalue_create_int(43);
		...
		/* Tests_SRS_AMQPVALUE_01_236: [If creating the cloned value fails, amqpvalue_clone shall return NULL.] */
		/* Tests_SRS_AMQPVALUE_01_246: [long] */
		TEST_METHOD(when_allocating_cloned_value_fails_amqpvalue_clone_for_a_long_fails)
		{
			// arrange
			amqpvalue_mocks mocks;
			AMQP_VALUE source = amqpvalue_create_long(43);
		...
		/* Tests_SRS_AMQPVALUE_01_236: [If creating the cloned value fails, amqpvalue_clone shall return NULL.] */
		/* Tests_SRS_AMQPVALUE_01_247: [float] */
		TEST_METHOD(when_allocating_cloned_value_fails_amqpvalue_clone_for_a_float_fails)
		{
			// arrange
			amqpvalue_mocks mocks;
			AMQP_VALUE source = amqpvalue_create_float(43);
		...
		/* Tests_SRS_AMQPVALUE_01_236: [If creating the cloned value fails, amqpvalue_clone shall return NULL.] */
		/* Tests_SRS_AMQPVALUE_01_248: [double] */
		TEST_METHOD(when_allocating_cloned_value_fails_amqpvalue_clone_for_a_double_fails)
		{
			// arrange
			amqpvalue_mocks mocks;
			AMQP_VALUE source = amqpvalue_create_double(43);
		...
		/* Tests_SRS_AMQPVALUE_01_236: [If creating the cloned value fails, amqpvalue_clone shall return NULL.] */
		/* Tests_SRS_AMQPVALUE_01_252: [char] */
		TEST_METHOD(when_allocating_cloned_value_fails_amqpvalue_clone_for_a_char_fails)
		{
			// arrange
			amqpvalue_mocks mocks;
			AMQP_VALUE source = amqpvalue_create_char(43);
		...
		/* Tests_SRS_AMQPVALUE_01_236: [If creating the cloned value fails, amqpvalue_clone shall return NULL.] */
		/* Tests_SRS_AMQPVALUE_01_253: [timestamp] */
		TEST_METHOD(when_allocating_cloned_value_fails_amqpvalue_clone_for_a_timestamp_fails)
		{
			// arrange
			amqpvalue_mocks mocks;
			AMQP_VALUE source = amqpvalue_create_timestamp(43);
		...
		/* Tests_SRS_AMQPVALUE_01_236: [If creating the cloned value fails, amqpvalue_clone shall return NULL.] */
		/* Tests_SRS_AMQPVALUE_01_254: [uuid] */
		TEST_METHOD(when_allocating_cloned_value_fails_amqpvalue_clone_for_a_uuid_fails)
		{
			// arrange
			amqpvalue_mocks mocks;
			amqp_uuid uuid_value = { 0x42, 0x43 };
		...
		/* Tests_SRS_AMQPVALUE_01_236: [If creating the cloned value fails, amqpvalue_clone shall return NULL.] */
		/* Tests_SRS_AMQPVALUE_01_255: [binary] */
		TEST_METHOD(when_allocating_cloned_value_fails_amqpvalue_clone_for_a_binary_fails)
		{
			// arrange
			amqpvalue_mocks mocks;
			unsigned char buffer[] = { 0x42, 0x43 };
		...
		/* Tests_SRS_AMQPVALUE_01_236: [If creating the cloned value fails, amqpvalue_clone shall return NULL.] */
		/* Tests_SRS_AMQPVALUE_01_255: [binary] */
		TEST_METHOD(when_allocating_the_underlying_buffer_amqpvalue_clone_for_a_binary_fails)
		{
			// arrange
			amqpvalue_mocks mocks;
			unsigned char buffer[] = { 0x42, 0x43 };
		...
		TEST_METHOD(when_allocating_the_cloned_value_amqpvalue_clone_for_a_string_fails)
		{
			// arrange
			amqpvalue_mocks mocks;
			AMQP_VALUE source = amqpvalue_create_string("abcd");
		...
		/* Tests_SRS_AMQPVALUE_01_236: [If creating the cloned value fails, amqpvalue_clone shall return NULL.] */
		/* Tests_SRS_AMQPVALUE_01_255: [string] */
		TEST_METHOD(when_allocating_the_underlying_buffer_amqpvalue_clone_for_a_string_fails)
		{
			// arrange
			amqpvalue_mocks mocks;
			AMQP_VALUE source = amqpvalue_create_string("abcd");
		...
		/* Tests_SRS_AMQPVALUE_01_236: [If creating the cloned value fails, amqpvalue_clone shall return NULL.] */
		/* Tests_SRS_AMQPVALUE_01_258: [list] */
		TEST_METHOD(when_allocating_the_cloned_value_amqpvalue_clone_for_a_list_fails)
		{
			// arrange
			amqpvalue_mocks mocks;
			AMQP_VALUE item1 = amqpvalue_create_uint(42);
		...
		/* Tests_SRS_AMQPVALUE_01_236: [If creating the cloned value fails, amqpvalue_clone shall return NULL.] */
		/* Tests_SRS_AMQPVALUE_01_258: [list] */
		TEST_METHOD(when_allocating_the_underlying_list_amqpvalue_clone_for_a_list_fails)
		{
			// arrange
			amqpvalue_mocks mocks;
			AMQP_VALUE item1 = amqpvalue_create_uint(42);
		...
		/* Tests_SRS_AMQPVALUE_01_236: [If creating the cloned value fails, amqpvalue_clone shall return NULL.] */
		/* Tests_SRS_AMQPVALUE_01_258: [list] */
		TEST_METHOD(when_allocating_the_first_cloned_value_amqpvalue_clone_for_a_list_fails)
		{
			// arrange
			amqpvalue_mocks mocks;
			AMQP_VALUE item1 = amqpvalue_create_uint(42);
		...
		/* Tests_SRS_AMQPVALUE_01_236: [If creating the cloned value fails, amqpvalue_clone shall return NULL.] */
		/* Tests_SRS_AMQPVALUE_01_258: [list] */
		TEST_METHOD(when_allocating_the_second_cloned_value_amqpvalue_clone_for_a_list_fails)
		{
			// arrange
			amqpvalue_mocks mocks;
			AMQP_VALUE item1 = amqpvalue_create_uint(42);
		...
		/* Tests_SRS_AMQPVALUE_01_236: [If creating the cloned value fails, amqpvalue_clone shall return NULL.] */
		/* Tests_SRS_AMQPVALUE_01_259: [map] */
		TEST_METHOD(when_allocating_the_cloned_value_fails_amqpvalue_clone_fails)
		{
			// arrange
			amqpvalue_mocks mocks;
			AMQP_VALUE key1 = amqpvalue_create_uint(42);
		...
		/* Tests_SRS_AMQPVALUE_01_236: [If creating the cloned value fails, amqpvalue_clone shall return NULL.] */
		/* Tests_SRS_AMQPVALUE_01_259: [map] */
		TEST_METHOD(when_allocating_the_underlying_map_array_fails_amqpvalue_clone_fails)
		{
			// arrange
			amqpvalue_mocks mocks;
			AMQP_VALUE key1 = amqpvalue_create_uint(42);
		...
		/* Tests_SRS_AMQPVALUE_01_236: [If creating the cloned value fails, amqpvalue_clone shall return NULL.] */
		/* Tests_SRS_AMQPVALUE_01_259: [map] */
		TEST_METHOD(when_allocating_the_first_cloned_key_fails_amqpvalue_clone_fails)
		{
			// arrange
			amqpvalue_mocks mocks;
			AMQP_VALUE key1 = amqpvalue_create_uint(42);
		...
		/* Tests_SRS_AMQPVALUE_01_236: [If creating the cloned value fails, amqpvalue_clone shall return NULL.] */
		/* Tests_SRS_AMQPVALUE_01_259: [map] */
		TEST_METHOD(when_allocating_the_first_cloned_value_fails_amqpvalue_clone_fails)
		{
			// arrange
			amqpvalue_mocks mocks;
			AMQP_VALUE key1 = amqpvalue_create_uint(42);
		...
		/* Tests_SRS_AMQPVALUE_01_236: [If creating the cloned value fails, amqpvalue_clone shall return NULL.] */
		/* Tests_SRS_AMQPVALUE_01_259: [map] */
		TEST_METHOD(when_allocating_the_second_cloned_key_fails_amqpvalue_clone_fails)
		{
			// arrange
			amqpvalue_mocks mocks;
			AMQP_VALUE key1 = amqpvalue_create_uint(42);
		...
		/* Tests_SRS_AMQPVALUE_01_236: [If creating the cloned value fails, amqpvalue_clone shall return NULL.] */
		/* Tests_SRS_AMQPVALUE_01_259: [map] */
		TEST_METHOD(when_allocating_the_second_cloned_value_fails_amqpvalue_clone_fails)
		{
			// arrange
			amqpvalue_mocks mocks;
			AMQP_VALUE key1 = amqpvalue_create_uint(42);
		...
		TEST_METHOD(amqpvalue_encode_empty_map_succeeds)
		{
			amqpvalue_mocks mocks;
			AMQP_VALUE source = amqpvalue_create_map();
