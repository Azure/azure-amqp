    ...
    sealed class SaslSwtHandler : SaslHandler
    {
        ...
        protected override void OnStart(SaslInit init, bool isClient)
        {
            if (isClient)
            {
                ...
                MessagingClientEtwProvider.Provider.EventWriteAmqpLogOperationVerbose(this, TraceOperation.Receive, message);
        ...
        void OnInit(SaslInit init)
        {
            ...
            if (init.InitialResponse.Count > 0)
            {
                ...
                MessagingClientEtwProvider.Provider.EventWriteAmqpLogOperationVerbose(this, TraceOperation.Initialize, token);
