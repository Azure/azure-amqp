...
public:
	...
	MOCK_STATIC_METHOD_5(, void, frame_received_callback_1, void*, context, const unsigned char*, type_specific, uint32_t, type_specific_size, const unsigned char*, frame_body, uint32_t, frame_body_size)
	MOCK_VOID_METHOD_END();
	MOCK_STATIC_METHOD_5(, void, frame_received_callback_2, void*, context, const unsigned char*, type_specific, uint32_t, type_specific_size, const unsigned char*, frame_body, uint32_t, frame_body_size)
	MOCK_VOID_METHOD_END();
...
extern "C"
{
	...
	DECLARE_GLOBAL_MOCK_METHOD_5(frame_codec_mocks, , void, frame_received_callback_1, void*, context, const unsigned char*, type_specific, uint32_t, type_specific_size, const unsigned char*, frame_body, uint32_t, frame_body_size);
	DECLARE_GLOBAL_MOCK_METHOD_5(frame_codec_mocks, , void, frame_received_callback_2, void*, context, const unsigned char*, type_specific, uint32_t, type_specific_size, const unsigned char*, frame_body, uint32_t, frame_body_size);
...
TEST_FUNCTION(frame_codec_create_with_NULL_frame_codec_decode_error_calback_context_succeeds)
{
	...
	// act
	FRAME_CODEC_HANDLE frame_codec = frame_codec_create(TEST_IO_HANDLE, test_frame_codec_decode_error, NULL, consolelogger_log);
...
TEST_FUNCTION(when_io_is_NULL_frame_codec_create_fails)
{
	...
	// act
	FRAME_CODEC_HANDLE frame_codec = frame_codec_create(NULL, test_frame_codec_decode_error, TEST_ERROR_CONTEXT, consolelogger_log);
...
TEST_FUNCTION(sending_a_frame_with_more_than_512_bytes_of_total_frame_size_fails_immediately_after_create)
{
	...
	// act
	int result = frame_codec_begin_encode_frame(frame_codec, 0, 505, NULL, 0);
...
TEST_FUNCTION(receiving_a_frame_with_exactly_512_bytes_of_total_frame_size_immediately_after_create_succeeds)
{
	...
	EXPECTED_CALL(mocks, list_item_get_value(IGNORED_PTR_ARG));
	EXPECTED_CALL(mocks, amqpalloc_malloc(IGNORED_NUM_ARG));
	STRICT_EXPECTED_CALL(mocks, frame_received_callback_1(frame_codec, IGNORED_PTR_ARG, 2, IGNORED_PTR_ARG, 504))
...
TEST_FUNCTION(when_a_frame_bigger_than_max_frame_size_is_sent_frame_codec_begin_encode_frame_fails)
{
	...
	// act
	int result = frame_codec_begin_encode_frame(frame_codec, 0, 1017, NULL, 0);
...
TEST_FUNCTION(receiving_a_frame_with_exactly_max_frame_size_bytes_of_total_frame_size_fails_succeeds)
{
	...
	EXPECTED_CALL(mocks, list_item_get_value(IGNORED_PTR_ARG));
	EXPECTED_CALL(mocks, amqpalloc_malloc(IGNORED_NUM_ARG));
	STRICT_EXPECTED_CALL(mocks, frame_received_callback_1(frame_codec, IGNORED_PTR_ARG, 2, IGNORED_PTR_ARG, 1016))
		.ValidateArgumentBuffer(2, &frame[6], 2)
...
/* Tests_SRS_FRAME_CODEC_01_100: [If the frame body size is 0, the frame_body pointer passed to frame_received_callback shall be NULL.] */
...
TEST_FUNCTION(receiving_a_frame_with_1_byte_frame_body_succeeds)
{
	...
	EXPECTED_CALL(mocks, list_item_get_value(IGNORED_PTR_ARG));
	EXPECTED_CALL(mocks, amqpalloc_malloc(IGNORED_NUM_ARG));
	STRICT_EXPECTED_CALL(mocks, frame_received_callback_1(frame_codec, IGNORED_PTR_ARG, 2, IGNORED_PTR_ARG, 1))
		.ValidateArgumentBuffer(2, &frame[6], 2)
...
TEST_FUNCTION(when_allocating_type_specific_data_fails_a_subsequent_decode_Call_fails)
{
	...
	frame_codec_mocks mocks;
	FRAME_CODEC_HANDLE frame_codec = frame_codec_create(TEST_IO_HANDLE, test_frame_codec_decode_error, TEST_ERROR_CONTEXT, consolelogger_log);
	frame_codec_subscribe(frame_codec, 0, frame_received_callback_1, frame_codec);
	mocks.ResetAllCalls();
	unsigned char frame[] = { 0x00, 0x00, 0x00, 0x09, 0x02, 0x00, 0x01, 0x02, 0x42 };
...
TEST_FUNCTION(frame_codec_subscribe_with_valid_args_succeeds)
{
	...
	// act
	int result = frame_codec_subscribe(frame_codec, 0, frame_received_callback_1, frame_codec);
...
TEST_FUNCTION(when_frame_codec_is_NULL_frame_codec_subscribe_fails)
{
	...
	// act
	int result = frame_codec_subscribe(NULL, 0, frame_received_callback_1, (void*)0x01);
...
/* Tests_SRS_FRAME_CODEC_01_034: [If any of the frame_codec or frame_received_callback arguments is NULL, frame_codec_subscribe shall return a non-zero value.] */
TEST_FUNCTION(when_frame_received_callback_is_NULL_frame_codec_subscribe_fails)
{
	// arrange
	frame_codec_mocks mocks;
	FRAME_CODEC_HANDLE frame_codec = frame_codec_create(TEST_IO_HANDLE, test_frame_codec_decode_error, TEST_ERROR_CONTEXT, consolelogger_log);
...
TEST_FUNCTION(when_2_subscriptions_exist_and_first_one_matches_the_callback_is_invoked)
{
	...
	FRAME_CODEC_HANDLE frame_codec = frame_codec_create(TEST_IO_HANDLE, test_frame_codec_decode_error, TEST_ERROR_CONTEXT, consolelogger_log);
	(void)frame_codec_subscribe(frame_codec, 0, frame_received_callback_1, frame_codec);
	(void)frame_codec_subscribe(frame_codec, 1, frame_received_callback_2, frame_codec);
	unsigned char frame[] = { 0x00, 0x00, 0x00, 0x0A, 0x02, 0x00, 0x01, 0x02, 0x42, 0x43 };
	mocks.ResetAllCalls();
...
TEST_FUNCTION(when_2_subscriptions_exist_and_second_one_matches_the_callback_is_invoked)
{
	...
	EXPECTED_CALL(mocks, list_item_get_value(IGNORED_PTR_ARG));
	EXPECTED_CALL(mocks, amqpalloc_malloc(IGNORED_NUM_ARG));
	STRICT_EXPECTED_CALL(mocks, frame_received_callback_2(frame_codec, IGNORED_PTR_ARG, 2, IGNORED_PTR_ARG, 2))
		.ValidateArgumentBuffer(2, &frame[6], 2)
		.ValidateArgumentBuffer(4, &frame[sizeof(frame) - 2], 2);
	EXPECTED_CALL(mocks, amqpalloc_free(IGNORED_PTR_ARG));
...
TEST_FUNCTION(when_frame_codec_subscribe_is_called_twice_for_the_same_frame_type_it_succeeds)
{
	...
	// act
	int result = frame_codec_subscribe(frame_codec, 0, frame_received_callback_2, frame_codec);
...
TEST_FUNCTION(the_callbacks_for_the_2nd_frame_codec_subscribe_for_the_same_frame_type_remain_in_effect)
{
	...
	FRAME_CODEC_HANDLE frame_codec = frame_codec_create(TEST_IO_HANDLE, test_frame_codec_decode_error, TEST_ERROR_CONTEXT, consolelogger_log);
	(void)frame_codec_subscribe(frame_codec, 0, frame_received_callback_1, frame_codec);
	(void)frame_codec_subscribe(frame_codec, 0, frame_received_callback_2, frame_codec);
	mocks.ResetAllCalls();
