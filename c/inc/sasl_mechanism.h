...
extern "C" {
	...
	typedef const char*(*SASL_MECHANISM_GET_MECHANISM_NAME)(SASL_MECHANISM_CONCRETE_HANDLE sasl_mechanism_concrete_handle);
	...
	typedef struct SASL_MECHANISM_INTERFACE_TAG
	{
		...
		SASL_MECHANISM_GET_MECHANISM_NAME sasl_mechanism_concrete_get_mechanism_name;
