...
#define FRAME_TYPE_SASL	(uint8_t)0x01
	...
	extern int frame_codec_begin_encode_frame(FRAME_CODEC_HANDLE frame_codec, uint32_t frame_body_size, const unsigned char* type_specific_bytes, uint32_t type_specific_size);
