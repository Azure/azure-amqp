...
extern "C"
{
	...
	DECLARE_GLOBAL_MOCK_METHOD_3(sasl_frame_codec_mocks, , FRAME_CODEC_HANDLE, frame_codec_create, IO_HANDLE, io, FRAME_CODEC_ERROR_CALLBACK, frame_codec_error_callback, LOGGER_LOG, logger_log);
