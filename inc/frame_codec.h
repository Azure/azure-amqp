...
#include <stddef.h>
	...
	extern int frame_codec_subscribe(FRAME_CODEC_HANDLE frame_codec_handle, uint8_t type, FRAME_RECEIVED_CALLBACK frame_received_callback, void* frame_received_callback_context);
	extern int frame_codec_unsubscribe(FRAME_CODEC_HANDLE frame_codec_handle, uint8_t type);
