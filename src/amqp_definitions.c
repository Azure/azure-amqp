...
/* error */
	...
	int error_get_condition(ERROR_HANDLE error, const char** condition_value)
	{
		...
		{
			ERROR_INSTANCE* error_instance = (ERROR_INSTANCE*)error;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(error_instance->composite_value, 0);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int error_get_description(ERROR_HANDLE error, const char** description_value)
	{
		...
		{
			ERROR_INSTANCE* error_instance = (ERROR_INSTANCE*)error;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(error_instance->composite_value, 1);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int error_get_info(ERROR_HANDLE error, fields* info_value)
	{
		...
		{
			ERROR_INSTANCE* error_instance = (ERROR_INSTANCE*)error;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(error_instance->composite_value, 2);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
...
/* open */
	...
	int open_get_container_id(OPEN_HANDLE open, const char** container_id_value)
	{
		...
		{
			OPEN_INSTANCE* open_instance = (OPEN_INSTANCE*)open;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(open_instance->composite_value, 0);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int open_get_hostname(OPEN_HANDLE open, const char** hostname_value)
	{
		...
		{
			OPEN_INSTANCE* open_instance = (OPEN_INSTANCE*)open;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(open_instance->composite_value, 1);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int open_get_max_frame_size(OPEN_HANDLE open, uint32_t* max_frame_size_value)
	{
		...
		{
			OPEN_INSTANCE* open_instance = (OPEN_INSTANCE*)open;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(open_instance->composite_value, 2);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int open_get_channel_max(OPEN_HANDLE open, uint16_t* channel_max_value)
	{
		...
		{
			OPEN_INSTANCE* open_instance = (OPEN_INSTANCE*)open;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(open_instance->composite_value, 3);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int open_get_idle_time_out(OPEN_HANDLE open, milliseconds* idle_time_out_value)
	{
		...
		{
			OPEN_INSTANCE* open_instance = (OPEN_INSTANCE*)open;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(open_instance->composite_value, 4);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int open_get_outgoing_locales(OPEN_HANDLE open, ietf_language_tag* outgoing_locales_value)
	{
		...
		{
			OPEN_INSTANCE* open_instance = (OPEN_INSTANCE*)open;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(open_instance->composite_value, 5);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int open_get_incoming_locales(OPEN_HANDLE open, ietf_language_tag* incoming_locales_value)
	{
		...
		{
			OPEN_INSTANCE* open_instance = (OPEN_INSTANCE*)open;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(open_instance->composite_value, 6);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int open_get_offered_capabilities(OPEN_HANDLE open, const char** offered_capabilities_value)
	{
		...
		{
			OPEN_INSTANCE* open_instance = (OPEN_INSTANCE*)open;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(open_instance->composite_value, 7);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int open_get_desired_capabilities(OPEN_HANDLE open, const char** desired_capabilities_value)
	{
		...
		{
			OPEN_INSTANCE* open_instance = (OPEN_INSTANCE*)open;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(open_instance->composite_value, 8);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int open_get_properties(OPEN_HANDLE open, fields* properties_value)
	{
		...
		{
			OPEN_INSTANCE* open_instance = (OPEN_INSTANCE*)open;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(open_instance->composite_value, 9);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
...
/* begin */
	...
	int begin_get_remote_channel(BEGIN_HANDLE begin, uint16_t* remote_channel_value)
	{
		...
		{
			BEGIN_INSTANCE* begin_instance = (BEGIN_INSTANCE*)begin;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(begin_instance->composite_value, 0);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int begin_get_next_outgoing_id(BEGIN_HANDLE begin, transfer_number* next_outgoing_id_value)
	{
		...
		{
			BEGIN_INSTANCE* begin_instance = (BEGIN_INSTANCE*)begin;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(begin_instance->composite_value, 1);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int begin_get_incoming_window(BEGIN_HANDLE begin, uint32_t* incoming_window_value)
	{
		...
		{
			BEGIN_INSTANCE* begin_instance = (BEGIN_INSTANCE*)begin;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(begin_instance->composite_value, 2);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int begin_get_outgoing_window(BEGIN_HANDLE begin, uint32_t* outgoing_window_value)
	{
		...
		{
			BEGIN_INSTANCE* begin_instance = (BEGIN_INSTANCE*)begin;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(begin_instance->composite_value, 3);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int begin_get_handle_max(BEGIN_HANDLE begin, handle* handle_max_value)
	{
		...
		{
			BEGIN_INSTANCE* begin_instance = (BEGIN_INSTANCE*)begin;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(begin_instance->composite_value, 4);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int begin_get_offered_capabilities(BEGIN_HANDLE begin, const char** offered_capabilities_value)
	{
		...
		{
			BEGIN_INSTANCE* begin_instance = (BEGIN_INSTANCE*)begin;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(begin_instance->composite_value, 5);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int begin_get_desired_capabilities(BEGIN_HANDLE begin, const char** desired_capabilities_value)
	{
		...
		{
			BEGIN_INSTANCE* begin_instance = (BEGIN_INSTANCE*)begin;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(begin_instance->composite_value, 6);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int begin_get_properties(BEGIN_HANDLE begin, fields* properties_value)
	{
		...
		{
			BEGIN_INSTANCE* begin_instance = (BEGIN_INSTANCE*)begin;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(begin_instance->composite_value, 7);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
...
/* attach */
	...
	int attach_get_name(ATTACH_HANDLE attach, const char** name_value)
	{
		...
		{
			ATTACH_INSTANCE* attach_instance = (ATTACH_INSTANCE*)attach;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(attach_instance->composite_value, 0);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int attach_get_handle(ATTACH_HANDLE attach, handle* handle_value)
	{
		...
		{
			ATTACH_INSTANCE* attach_instance = (ATTACH_INSTANCE*)attach;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(attach_instance->composite_value, 1);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int attach_get_role(ATTACH_HANDLE attach, role* role_value)
	{
		...
		{
			ATTACH_INSTANCE* attach_instance = (ATTACH_INSTANCE*)attach;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(attach_instance->composite_value, 2);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int attach_get_snd_settle_mode(ATTACH_HANDLE attach, sender_settle_mode* snd_settle_mode_value)
	{
		...
		{
			ATTACH_INSTANCE* attach_instance = (ATTACH_INSTANCE*)attach;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(attach_instance->composite_value, 3);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int attach_get_rcv_settle_mode(ATTACH_HANDLE attach, receiver_settle_mode* rcv_settle_mode_value)
	{
		...
		{
			ATTACH_INSTANCE* attach_instance = (ATTACH_INSTANCE*)attach;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(attach_instance->composite_value, 4);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int attach_get_source(ATTACH_HANDLE attach, AMQP_VALUE* source_value)
	{
		...
		{
			ATTACH_INSTANCE* attach_instance = (ATTACH_INSTANCE*)attach;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(attach_instance->composite_value, 5);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int attach_get_target(ATTACH_HANDLE attach, AMQP_VALUE* target_value)
	{
		...
		{
			ATTACH_INSTANCE* attach_instance = (ATTACH_INSTANCE*)attach;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(attach_instance->composite_value, 6);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int attach_get_unsettled(ATTACH_HANDLE attach, AMQP_VALUE* unsettled_value)
	{
		...
		{
			ATTACH_INSTANCE* attach_instance = (ATTACH_INSTANCE*)attach;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(attach_instance->composite_value, 7);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int attach_get_incomplete_unsettled(ATTACH_HANDLE attach, bool* incomplete_unsettled_value)
	{
		...
		{
			ATTACH_INSTANCE* attach_instance = (ATTACH_INSTANCE*)attach;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(attach_instance->composite_value, 8);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int attach_get_initial_delivery_count(ATTACH_HANDLE attach, sequence_no* initial_delivery_count_value)
	{
		...
		{
			ATTACH_INSTANCE* attach_instance = (ATTACH_INSTANCE*)attach;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(attach_instance->composite_value, 9);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int attach_get_max_message_size(ATTACH_HANDLE attach, uint64_t* max_message_size_value)
	{
		...
		{
			ATTACH_INSTANCE* attach_instance = (ATTACH_INSTANCE*)attach;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(attach_instance->composite_value, 10);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int attach_get_offered_capabilities(ATTACH_HANDLE attach, const char** offered_capabilities_value)
	{
		...
		{
			ATTACH_INSTANCE* attach_instance = (ATTACH_INSTANCE*)attach;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(attach_instance->composite_value, 11);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int attach_get_desired_capabilities(ATTACH_HANDLE attach, const char** desired_capabilities_value)
	{
		...
		{
			ATTACH_INSTANCE* attach_instance = (ATTACH_INSTANCE*)attach;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(attach_instance->composite_value, 12);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int attach_get_properties(ATTACH_HANDLE attach, fields* properties_value)
	{
		...
		{
			ATTACH_INSTANCE* attach_instance = (ATTACH_INSTANCE*)attach;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(attach_instance->composite_value, 13);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
...
/* flow */
	...
	int flow_get_next_incoming_id(FLOW_HANDLE flow, transfer_number* next_incoming_id_value)
	{
		...
		{
			FLOW_INSTANCE* flow_instance = (FLOW_INSTANCE*)flow;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(flow_instance->composite_value, 0);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int flow_get_incoming_window(FLOW_HANDLE flow, uint32_t* incoming_window_value)
	{
		...
		{
			FLOW_INSTANCE* flow_instance = (FLOW_INSTANCE*)flow;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(flow_instance->composite_value, 1);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int flow_get_next_outgoing_id(FLOW_HANDLE flow, transfer_number* next_outgoing_id_value)
	{
		...
		{
			FLOW_INSTANCE* flow_instance = (FLOW_INSTANCE*)flow;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(flow_instance->composite_value, 2);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int flow_get_outgoing_window(FLOW_HANDLE flow, uint32_t* outgoing_window_value)
	{
		...
		{
			FLOW_INSTANCE* flow_instance = (FLOW_INSTANCE*)flow;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(flow_instance->composite_value, 3);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int flow_get_handle(FLOW_HANDLE flow, handle* handle_value)
	{
		...
		{
			FLOW_INSTANCE* flow_instance = (FLOW_INSTANCE*)flow;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(flow_instance->composite_value, 4);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int flow_get_delivery_count(FLOW_HANDLE flow, sequence_no* delivery_count_value)
	{
		...
		{
			FLOW_INSTANCE* flow_instance = (FLOW_INSTANCE*)flow;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(flow_instance->composite_value, 5);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int flow_get_link_credit(FLOW_HANDLE flow, uint32_t* link_credit_value)
	{
		...
		{
			FLOW_INSTANCE* flow_instance = (FLOW_INSTANCE*)flow;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(flow_instance->composite_value, 6);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int flow_get_available(FLOW_HANDLE flow, uint32_t* available_value)
	{
		...
		{
			FLOW_INSTANCE* flow_instance = (FLOW_INSTANCE*)flow;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(flow_instance->composite_value, 7);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int flow_get_drain(FLOW_HANDLE flow, bool* drain_value)
	{
		...
		{
			FLOW_INSTANCE* flow_instance = (FLOW_INSTANCE*)flow;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(flow_instance->composite_value, 8);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int flow_get_echo(FLOW_HANDLE flow, bool* echo_value)
	{
		...
		{
			FLOW_INSTANCE* flow_instance = (FLOW_INSTANCE*)flow;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(flow_instance->composite_value, 9);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int flow_get_properties(FLOW_HANDLE flow, fields* properties_value)
	{
		...
		{
			FLOW_INSTANCE* flow_instance = (FLOW_INSTANCE*)flow;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(flow_instance->composite_value, 10);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
...
/* transfer */
	...
	int transfer_get_handle(TRANSFER_HANDLE transfer, handle* handle_value)
	{
		...
		{
			TRANSFER_INSTANCE* transfer_instance = (TRANSFER_INSTANCE*)transfer;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(transfer_instance->composite_value, 0);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int transfer_get_delivery_id(TRANSFER_HANDLE transfer, delivery_number* delivery_id_value)
	{
		...
		{
			TRANSFER_INSTANCE* transfer_instance = (TRANSFER_INSTANCE*)transfer;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(transfer_instance->composite_value, 1);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int transfer_get_delivery_tag(TRANSFER_HANDLE transfer, delivery_tag* delivery_tag_value)
	{
		...
		{
			TRANSFER_INSTANCE* transfer_instance = (TRANSFER_INSTANCE*)transfer;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(transfer_instance->composite_value, 2);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int transfer_get_message_format(TRANSFER_HANDLE transfer, message_format* message_format_value)
	{
		...
		{
			TRANSFER_INSTANCE* transfer_instance = (TRANSFER_INSTANCE*)transfer;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(transfer_instance->composite_value, 3);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int transfer_get_settled(TRANSFER_HANDLE transfer, bool* settled_value)
	{
		...
		{
			TRANSFER_INSTANCE* transfer_instance = (TRANSFER_INSTANCE*)transfer;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(transfer_instance->composite_value, 4);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int transfer_get_more(TRANSFER_HANDLE transfer, bool* more_value)
	{
		...
		{
			TRANSFER_INSTANCE* transfer_instance = (TRANSFER_INSTANCE*)transfer;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(transfer_instance->composite_value, 5);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int transfer_get_rcv_settle_mode(TRANSFER_HANDLE transfer, receiver_settle_mode* rcv_settle_mode_value)
	{
		...
		{
			TRANSFER_INSTANCE* transfer_instance = (TRANSFER_INSTANCE*)transfer;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(transfer_instance->composite_value, 6);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int transfer_get_state(TRANSFER_HANDLE transfer, AMQP_VALUE* state_value)
	{
		...
		{
			TRANSFER_INSTANCE* transfer_instance = (TRANSFER_INSTANCE*)transfer;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(transfer_instance->composite_value, 7);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int transfer_get_resume(TRANSFER_HANDLE transfer, bool* resume_value)
	{
		...
		{
			TRANSFER_INSTANCE* transfer_instance = (TRANSFER_INSTANCE*)transfer;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(transfer_instance->composite_value, 8);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int transfer_get_aborted(TRANSFER_HANDLE transfer, bool* aborted_value)
	{
		...
		{
			TRANSFER_INSTANCE* transfer_instance = (TRANSFER_INSTANCE*)transfer;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(transfer_instance->composite_value, 9);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int transfer_get_batchable(TRANSFER_HANDLE transfer, bool* batchable_value)
	{
		...
		{
			TRANSFER_INSTANCE* transfer_instance = (TRANSFER_INSTANCE*)transfer;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(transfer_instance->composite_value, 10);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
...
/* disposition */
	...
	int disposition_get_role(DISPOSITION_HANDLE disposition, role* role_value)
	{
		...
		{
			DISPOSITION_INSTANCE* disposition_instance = (DISPOSITION_INSTANCE*)disposition;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(disposition_instance->composite_value, 0);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int disposition_get_first(DISPOSITION_HANDLE disposition, delivery_number* first_value)
	{
		...
		{
			DISPOSITION_INSTANCE* disposition_instance = (DISPOSITION_INSTANCE*)disposition;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(disposition_instance->composite_value, 1);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int disposition_get_last(DISPOSITION_HANDLE disposition, delivery_number* last_value)
	{
		...
		{
			DISPOSITION_INSTANCE* disposition_instance = (DISPOSITION_INSTANCE*)disposition;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(disposition_instance->composite_value, 2);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int disposition_get_settled(DISPOSITION_HANDLE disposition, bool* settled_value)
	{
		...
		{
			DISPOSITION_INSTANCE* disposition_instance = (DISPOSITION_INSTANCE*)disposition;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(disposition_instance->composite_value, 3);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int disposition_get_state(DISPOSITION_HANDLE disposition, AMQP_VALUE* state_value)
	{
		...
		{
			DISPOSITION_INSTANCE* disposition_instance = (DISPOSITION_INSTANCE*)disposition;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(disposition_instance->composite_value, 4);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int disposition_get_batchable(DISPOSITION_HANDLE disposition, bool* batchable_value)
	{
		...
		{
			DISPOSITION_INSTANCE* disposition_instance = (DISPOSITION_INSTANCE*)disposition;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(disposition_instance->composite_value, 5);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
...
/* detach */
	...
	int detach_get_handle(DETACH_HANDLE detach, handle* handle_value)
	{
		...
		{
			DETACH_INSTANCE* detach_instance = (DETACH_INSTANCE*)detach;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(detach_instance->composite_value, 0);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int detach_get_closed(DETACH_HANDLE detach, bool* closed_value)
	{
		...
		{
			DETACH_INSTANCE* detach_instance = (DETACH_INSTANCE*)detach;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(detach_instance->composite_value, 1);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int detach_get_error(DETACH_HANDLE detach, ERROR_HANDLE* error_value)
	{
		...
		{
			DETACH_INSTANCE* detach_instance = (DETACH_INSTANCE*)detach;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(detach_instance->composite_value, 2);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
...
/* end */
	...
	int end_get_error(END_HANDLE end, ERROR_HANDLE* error_value)
	{
		...
		{
			END_INSTANCE* end_instance = (END_INSTANCE*)end;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(end_instance->composite_value, 0);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
...
/* close */
	...
	int close_get_error(CLOSE_HANDLE close, ERROR_HANDLE* error_value)
	{
		...
		{
			CLOSE_INSTANCE* close_instance = (CLOSE_INSTANCE*)close;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(close_instance->composite_value, 0);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
...
/* sasl-mechanisms */
	...
	int sasl_mechanisms_get_sasl_server_mechanisms(SASL_MECHANISMS_HANDLE sasl_mechanisms, const char** sasl_server_mechanisms_value)
	{
		...
		{
			SASL_MECHANISMS_INSTANCE* sasl_mechanisms_instance = (SASL_MECHANISMS_INSTANCE*)sasl_mechanisms;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(sasl_mechanisms_instance->composite_value, 0);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
...
/* sasl-init */
	...
	int sasl_init_get_mechanism(SASL_INIT_HANDLE sasl_init, const char** mechanism_value)
	{
		...
		{
			SASL_INIT_INSTANCE* sasl_init_instance = (SASL_INIT_INSTANCE*)sasl_init;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(sasl_init_instance->composite_value, 0);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int sasl_init_get_initial_response(SASL_INIT_HANDLE sasl_init, amqp_binary* initial_response_value)
	{
		...
		{
			SASL_INIT_INSTANCE* sasl_init_instance = (SASL_INIT_INSTANCE*)sasl_init;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(sasl_init_instance->composite_value, 1);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int sasl_init_get_hostname(SASL_INIT_HANDLE sasl_init, const char** hostname_value)
	{
		...
		{
			SASL_INIT_INSTANCE* sasl_init_instance = (SASL_INIT_INSTANCE*)sasl_init;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(sasl_init_instance->composite_value, 2);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
...
/* sasl-challenge */
	...
	int sasl_challenge_get_challenge(SASL_CHALLENGE_HANDLE sasl_challenge, amqp_binary* challenge_value)
	{
		...
		{
			SASL_CHALLENGE_INSTANCE* sasl_challenge_instance = (SASL_CHALLENGE_INSTANCE*)sasl_challenge;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(sasl_challenge_instance->composite_value, 0);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
...
/* sasl-response */
	...
	int sasl_response_get_response(SASL_RESPONSE_HANDLE sasl_response, amqp_binary* response_value)
	{
		...
		{
			SASL_RESPONSE_INSTANCE* sasl_response_instance = (SASL_RESPONSE_INSTANCE*)sasl_response;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(sasl_response_instance->composite_value, 0);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
...
/* sasl-outcome */
	...
	int sasl_outcome_get_code(SASL_OUTCOME_HANDLE sasl_outcome, sasl_code* code_value)
	{
		...
		{
			SASL_OUTCOME_INSTANCE* sasl_outcome_instance = (SASL_OUTCOME_INSTANCE*)sasl_outcome;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(sasl_outcome_instance->composite_value, 0);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int sasl_outcome_get_additional_data(SASL_OUTCOME_HANDLE sasl_outcome, amqp_binary* additional_data_value)
	{
		...
		{
			SASL_OUTCOME_INSTANCE* sasl_outcome_instance = (SASL_OUTCOME_INSTANCE*)sasl_outcome;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(sasl_outcome_instance->composite_value, 1);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
...
/* source */
	...
	int source_get_address(SOURCE_HANDLE source, AMQP_VALUE* address_value)
	{
		...
		{
			SOURCE_INSTANCE* source_instance = (SOURCE_INSTANCE*)source;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(source_instance->composite_value, 0);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int source_set_address(SOURCE_HANDLE source, AMQP_VALUE address_value)
	{
		...
		else
		{
			...
			if ((address_amqp_value == NULL) ||
				(amqpvalue_set_composite_item(source_instance->composite_value, 0, address_amqp_value) != 0))
			{
				result = __LINE__;
			}
			else
	...
	int source_get_durable(SOURCE_HANDLE source, terminus_durability* durable_value)
	{
		...
		{
			SOURCE_INSTANCE* source_instance = (SOURCE_INSTANCE*)source;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(source_instance->composite_value, 1);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int source_set_durable(SOURCE_HANDLE source, terminus_durability durable_value)
	{
		...
		else
		{
			...
			if ((durable_amqp_value == NULL) ||
				(amqpvalue_set_composite_item(source_instance->composite_value, 1, durable_amqp_value) != 0))
			{
				result = __LINE__;
			}
			else
	...
	int source_get_expiry_policy(SOURCE_HANDLE source, terminus_expiry_policy* expiry_policy_value)
	{
		...
		{
			SOURCE_INSTANCE* source_instance = (SOURCE_INSTANCE*)source;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(source_instance->composite_value, 2);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int source_set_expiry_policy(SOURCE_HANDLE source, terminus_expiry_policy expiry_policy_value)
	{
		...
		else
		{
			...
			if ((expiry_policy_amqp_value == NULL) ||
				(amqpvalue_set_composite_item(source_instance->composite_value, 2, expiry_policy_amqp_value) != 0))
			{
				result = __LINE__;
			}
			else
	...
	int source_get_timeout(SOURCE_HANDLE source, seconds* timeout_value)
	{
		...
		{
			SOURCE_INSTANCE* source_instance = (SOURCE_INSTANCE*)source;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(source_instance->composite_value, 3);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int source_set_timeout(SOURCE_HANDLE source, seconds timeout_value)
	{
		...
		else
		{
			...
			if ((timeout_amqp_value == NULL) ||
				(amqpvalue_set_composite_item(source_instance->composite_value, 3, timeout_amqp_value) != 0))
			{
				result = __LINE__;
			}
			else
	...
	int source_get_dynamic(SOURCE_HANDLE source, bool* dynamic_value)
	{
		...
		{
			SOURCE_INSTANCE* source_instance = (SOURCE_INSTANCE*)source;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(source_instance->composite_value, 4);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int source_set_dynamic(SOURCE_HANDLE source, bool dynamic_value)
	{
		...
		else
		{
			...
			if ((dynamic_amqp_value == NULL) ||
				(amqpvalue_set_composite_item(source_instance->composite_value, 4, dynamic_amqp_value) != 0))
			{
				result = __LINE__;
			}
			else
	...
	int source_get_dynamic_node_properties(SOURCE_HANDLE source, node_properties* dynamic_node_properties_value)
	{
		...
		{
			SOURCE_INSTANCE* source_instance = (SOURCE_INSTANCE*)source;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(source_instance->composite_value, 5);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int source_set_dynamic_node_properties(SOURCE_HANDLE source, node_properties dynamic_node_properties_value)
	{
		...
		else
		{
			...
			if ((dynamic_node_properties_amqp_value == NULL) ||
				(amqpvalue_set_composite_item(source_instance->composite_value, 5, dynamic_node_properties_amqp_value) != 0))
			{
				result = __LINE__;
			}
			else
	...
	int source_get_distribution_mode(SOURCE_HANDLE source, const char** distribution_mode_value)
	{
		...
		{
			SOURCE_INSTANCE* source_instance = (SOURCE_INSTANCE*)source;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(source_instance->composite_value, 6);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int source_set_distribution_mode(SOURCE_HANDLE source, const char* distribution_mode_value)
	{
		...
		else
		{
			...
			if ((distribution_mode_amqp_value == NULL) ||
				(amqpvalue_set_composite_item(source_instance->composite_value, 6, distribution_mode_amqp_value) != 0))
			{
				result = __LINE__;
			}
			else
	...
	int source_get_filter(SOURCE_HANDLE source, filter_set* filter_value)
	{
		...
		{
			SOURCE_INSTANCE* source_instance = (SOURCE_INSTANCE*)source;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(source_instance->composite_value, 7);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int source_set_filter(SOURCE_HANDLE source, filter_set filter_value)
	{
		...
		else
		{
			...
			if ((filter_amqp_value == NULL) ||
				(amqpvalue_set_composite_item(source_instance->composite_value, 7, filter_amqp_value) != 0))
			{
				result = __LINE__;
			}
			else
	...
	int source_get_default_outcome(SOURCE_HANDLE source, AMQP_VALUE* default_outcome_value)
	{
		...
		{
			SOURCE_INSTANCE* source_instance = (SOURCE_INSTANCE*)source;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(source_instance->composite_value, 8);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int source_set_default_outcome(SOURCE_HANDLE source, AMQP_VALUE default_outcome_value)
	{
		...
		else
		{
			...
			if ((default_outcome_amqp_value == NULL) ||
				(amqpvalue_set_composite_item(source_instance->composite_value, 8, default_outcome_amqp_value) != 0))
			{
				result = __LINE__;
			}
			else
	...
	int source_get_outcomes(SOURCE_HANDLE source, const char** outcomes_value)
	{
		...
		{
			SOURCE_INSTANCE* source_instance = (SOURCE_INSTANCE*)source;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(source_instance->composite_value, 9);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int source_set_outcomes(SOURCE_HANDLE source, const char* outcomes_value)
	{
		...
		else
		{
			...
			if ((outcomes_amqp_value == NULL) ||
				(amqpvalue_set_composite_item(source_instance->composite_value, 9, outcomes_amqp_value) != 0))
			{
				result = __LINE__;
			}
			else
	...
	int source_get_capabilities(SOURCE_HANDLE source, const char** capabilities_value)
	{
		...
		{
			SOURCE_INSTANCE* source_instance = (SOURCE_INSTANCE*)source;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(source_instance->composite_value, 10);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int source_set_capabilities(SOURCE_HANDLE source, const char* capabilities_value)
	{
		...
		else
		{
			...
			if ((capabilities_amqp_value == NULL) ||
				(amqpvalue_set_composite_item(source_instance->composite_value, 10, capabilities_amqp_value) != 0))
			{
				result = __LINE__;
			}
			else
...
/* target */
	...
	int target_get_address(TARGET_HANDLE target, AMQP_VALUE* address_value)
	{
		...
		{
			TARGET_INSTANCE* target_instance = (TARGET_INSTANCE*)target;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(target_instance->composite_value, 0);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int target_set_address(TARGET_HANDLE target, AMQP_VALUE address_value)
	{
		...
		else
		{
			...
			AMQP_VALUE address_amqp_value = amqpvalue_clone(address_value);
			if ((address_amqp_value == NULL) ||
				(amqpvalue_set_composite_item(target_instance->composite_value, 0, address_amqp_value) != 0))
			{
				result = __LINE__;
			}
			else
	...
	int target_get_durable(TARGET_HANDLE target, terminus_durability* durable_value)
	{
		...
		{
			TARGET_INSTANCE* target_instance = (TARGET_INSTANCE*)target;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(target_instance->composite_value, 1);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int target_set_durable(TARGET_HANDLE target, terminus_durability durable_value)
	{
		...
		else
		{
			...
			AMQP_VALUE durable_amqp_value = amqpvalue_create_terminus_durability(durable_value);
			if ((durable_amqp_value == NULL) ||
				(amqpvalue_set_composite_item(target_instance->composite_value, 1, durable_amqp_value) != 0))
			{
				result = __LINE__;
			}
			else
	...
	int target_get_expiry_policy(TARGET_HANDLE target, terminus_expiry_policy* expiry_policy_value)
	{
		...
		{
			TARGET_INSTANCE* target_instance = (TARGET_INSTANCE*)target;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(target_instance->composite_value, 2);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int target_set_expiry_policy(TARGET_HANDLE target, terminus_expiry_policy expiry_policy_value)
	{
		...
		else
		{
			...
			AMQP_VALUE expiry_policy_amqp_value = amqpvalue_create_terminus_expiry_policy(expiry_policy_value);
			if ((expiry_policy_amqp_value == NULL) ||
				(amqpvalue_set_composite_item(target_instance->composite_value, 2, expiry_policy_amqp_value) != 0))
			{
				result = __LINE__;
			}
			else
	...
	int target_get_timeout(TARGET_HANDLE target, seconds* timeout_value)
	{
		...
		{
			TARGET_INSTANCE* target_instance = (TARGET_INSTANCE*)target;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(target_instance->composite_value, 3);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int target_set_timeout(TARGET_HANDLE target, seconds timeout_value)
	{
		...
		else
		{
			...
			AMQP_VALUE timeout_amqp_value = amqpvalue_create_seconds(timeout_value);
			if ((timeout_amqp_value == NULL) ||
				(amqpvalue_set_composite_item(target_instance->composite_value, 3, timeout_amqp_value) != 0))
			{
				result = __LINE__;
			}
			else
	...
	int target_get_dynamic(TARGET_HANDLE target, bool* dynamic_value)
	{
		...
		{
			TARGET_INSTANCE* target_instance = (TARGET_INSTANCE*)target;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(target_instance->composite_value, 4);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int target_set_dynamic(TARGET_HANDLE target, bool dynamic_value)
	{
		...
		else
		{
			...
			AMQP_VALUE dynamic_amqp_value = amqpvalue_create_boolean(dynamic_value);
			if ((dynamic_amqp_value == NULL) ||
				(amqpvalue_set_composite_item(target_instance->composite_value, 4, dynamic_amqp_value) != 0))
			{
				result = __LINE__;
			}
			else
	...
	int target_get_dynamic_node_properties(TARGET_HANDLE target, node_properties* dynamic_node_properties_value)
	{
		...
		{
			TARGET_INSTANCE* target_instance = (TARGET_INSTANCE*)target;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(target_instance->composite_value, 5);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int target_set_dynamic_node_properties(TARGET_HANDLE target, node_properties dynamic_node_properties_value)
	{
		...
		else
		{
			...
			AMQP_VALUE dynamic_node_properties_amqp_value = amqpvalue_create_node_properties(dynamic_node_properties_value);
			if ((dynamic_node_properties_amqp_value == NULL) ||
				(amqpvalue_set_composite_item(target_instance->composite_value, 5, dynamic_node_properties_amqp_value) != 0))
			{
				result = __LINE__;
			}
			else
	...
	int target_get_capabilities(TARGET_HANDLE target, const char** capabilities_value)
	{
		...
		{
			TARGET_INSTANCE* target_instance = (TARGET_INSTANCE*)target;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(target_instance->composite_value, 6);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int target_set_capabilities(TARGET_HANDLE target, const char* capabilities_value)
	{
		...
		else
		{
			...
			AMQP_VALUE capabilities_amqp_value = amqpvalue_create_symbol(capabilities_value);
			if ((capabilities_amqp_value == NULL) ||
				(amqpvalue_set_composite_item(target_instance->composite_value, 6, capabilities_amqp_value) != 0))
			{
				result = __LINE__;
			}
			else
...
/* properties */
	...
	int properties_get_message_id(PROPERTIES_HANDLE properties, AMQP_VALUE* message_id_value)
	{
		...
		{
			PROPERTIES_INSTANCE* properties_instance = (PROPERTIES_INSTANCE*)properties;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(properties_instance->composite_value, 0);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int properties_get_user_id(PROPERTIES_HANDLE properties, amqp_binary* user_id_value)
	{
		...
		{
			PROPERTIES_INSTANCE* properties_instance = (PROPERTIES_INSTANCE*)properties;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(properties_instance->composite_value, 1);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int properties_get_to(PROPERTIES_HANDLE properties, AMQP_VALUE* to_value)
	{
		...
		{
			PROPERTIES_INSTANCE* properties_instance = (PROPERTIES_INSTANCE*)properties;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(properties_instance->composite_value, 2);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int properties_get_subject(PROPERTIES_HANDLE properties, const char** subject_value)
	{
		...
		{
			PROPERTIES_INSTANCE* properties_instance = (PROPERTIES_INSTANCE*)properties;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(properties_instance->composite_value, 3);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int properties_get_reply_to(PROPERTIES_HANDLE properties, AMQP_VALUE* reply_to_value)
	{
		...
		{
			PROPERTIES_INSTANCE* properties_instance = (PROPERTIES_INSTANCE*)properties;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(properties_instance->composite_value, 4);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int properties_get_correlation_id(PROPERTIES_HANDLE properties, AMQP_VALUE* correlation_id_value)
	{
		...
		{
			PROPERTIES_INSTANCE* properties_instance = (PROPERTIES_INSTANCE*)properties;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(properties_instance->composite_value, 5);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int properties_get_content_type(PROPERTIES_HANDLE properties, const char** content_type_value)
	{
		...
		{
			PROPERTIES_INSTANCE* properties_instance = (PROPERTIES_INSTANCE*)properties;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(properties_instance->composite_value, 6);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int properties_get_content_encoding(PROPERTIES_HANDLE properties, const char** content_encoding_value)
	{
		...
		{
			PROPERTIES_INSTANCE* properties_instance = (PROPERTIES_INSTANCE*)properties;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(properties_instance->composite_value, 7);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int properties_get_absolute_expiry_time(PROPERTIES_HANDLE properties, timestamp* absolute_expiry_time_value)
	{
		...
		{
			PROPERTIES_INSTANCE* properties_instance = (PROPERTIES_INSTANCE*)properties;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(properties_instance->composite_value, 8);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int properties_get_creation_time(PROPERTIES_HANDLE properties, timestamp* creation_time_value)
	{
		...
		{
			PROPERTIES_INSTANCE* properties_instance = (PROPERTIES_INSTANCE*)properties;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(properties_instance->composite_value, 9);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int properties_get_group_id(PROPERTIES_HANDLE properties, const char** group_id_value)
	{
		...
		{
			PROPERTIES_INSTANCE* properties_instance = (PROPERTIES_INSTANCE*)properties;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(properties_instance->composite_value, 10);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int properties_get_group_sequence(PROPERTIES_HANDLE properties, sequence_no* group_sequence_value)
	{
		...
		{
			PROPERTIES_INSTANCE* properties_instance = (PROPERTIES_INSTANCE*)properties;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(properties_instance->composite_value, 11);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
	...
	int properties_get_reply_to_group_id(PROPERTIES_HANDLE properties, const char** reply_to_group_id_value)
	{
		...
		{
			PROPERTIES_INSTANCE* properties_instance = (PROPERTIES_INSTANCE*)properties;
			AMQP_VALUE item_value = amqpvalue_get_composite_item(properties_instance->composite_value, 12);
			if (item_value == NULL)
			{
				result = __LINE__;
			}
