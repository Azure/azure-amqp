...
extern "C" int whenizero(void){return 0;}
...
extern "C" int whensix  (_In_ char c1, _In_ char c2, _In_ char c3, _In_ char c4, _In_ char c5, _In_ char c6)
{
    ...
    UNREFERENCED_PARAMETER(c3);
    UNREFERENCED_PARAMETER(c4);
    UNREFERENCED_PARAMETER(c5);
    UNREFERENCED_PARAMETER(c6);
    return 0;
}
...
public: 
    ...
    MOCK_HOOK_TD_METHOD_0(, void, whenzero)
    MOCK_VOID_METHOD_END()

    MOCK_HOOK_TD_METHOD_0(, int, whenizero)
    MOCK_METHOD_END(int, 0)

    MOCK_HOOK_TD_METHOD_1(, int, whenone, _In_ int, i)
    MOCK_METHOD_END(int, 0)

    MOCK_HOOK_TD_METHOD_2(, int, whentwo, _In_ pChar, s, _In_ int, i)
    MOCK_METHOD_END(int, 0)

    MOCK_HOOK_TD_METHOD_3(, int, whenthree, _In_ char, c, _In_ pChar, s, _In_ int, i);
    MOCK_METHOD_END(int, 0)

    MOCK_HOOK_TD_METHOD_4(, int, whenfour, _In_ unsigned short int, si, _In_ char, c, _In_ pChar, s, _In_ int, i);
    MOCK_METHOD_END(int, 0)

    MOCK_HOOK_TD_METHOD_5(, int, whenfive, _In_ pVoidFunction, pVoid, _In_ unsigned short int, si, _In_ char, c, _In_ pChar, s, _In_ int, i);    
    MOCK_METHOD_END(int, 0)

    MOCK_HOOK_TD_METHOD_6(,int, whensix, _In_ char, c1, _In_ char, c2, _In_ char, c3, _In_ char, c4, _In_ char, c5, _In_ char, c6);
    MOCK_METHOD_END(int, 0)
};
...
BEGIN_TEST_SUITE(MicroMockStimTest)
    ...
    TEST_FUNCTION_CLEANUP(d)
    {
        ...
        TEST_FUNCTION(TimeDiscreteMicroMock_A_STIM_with_2buffers_still_works_NULL_1int)
        {
            ...
            //assert
            ASSERT_ARE_EQUAL(bool, true, NULL==STIM_FunctionThatTakesTwoArrays_array1_called_pointer);        
            ASSERT_ARE_EQUAL(bol, false, NULL==STIM_FunctionThatTakesTwoArrays_array2_called_pointer);        
        ...
        TEST_FUNCTION(TimeDiscreteMicroMock_A_STIM_with_2buffers_still_works_1int_NULL)
        {
            ...
            ASSERT_ARE_EQUAL(bool, true, NULL==STIM_FunctionThatTakesTwoArrays_array2_called_pointer);        
            ASSERT_ARE_EQUAL(bool, 3, STIM_FunctionThatTakesTwoArrays_array1_copy[0]);
        }
