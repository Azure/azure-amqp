...
namespace System.Collections.Generic
{
    ...
    public class KeyedByTypeCollection<TItem> : KeyedCollection<Type, TItem>
    {
        ...
        /// <returns>The object of type <typeparamref name="T" /> if it is a reference type and the value of type <typeparamref name="T" /> if it is a value type. The default value of the type is returned if no object of type <typeparamref name="T" /> is contained in the collection: null if it is a reference type and 0 if it is a value type.</returns>
        ...
        /// <summary>Returns a collection of objects of type <typeparamref name="T" /> that are contained in the <see cref="T:System.Collections.Generic.KeyedByTypeCollection`1" />.</summary>
        /// <returns>A <see cref="T:System.Collections.ObjectModel.Collection`1" /> of type <typeparamref name="T" /> that contains the objects of type <typeparamref name="T" /> from the original collection.</returns>
        /// <typeparam name="T">The type of item in the collection to find.</typeparam>
        ...
        /// <returns>The <see cref="T:System.Collections.ObjectModel.Collection`1" /> that contains the objects of type <typeparamref name="T" /> from the original collection.</returns>
        /// <typeparam name="T">The type of item in the collection to remove.</typeparam>
